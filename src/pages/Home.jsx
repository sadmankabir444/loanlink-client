    ...
    <div className="overflow-hidden">
      ...
      >
        ...
        >
          ...
          <p className="text-base md:text-lg opacity-90 mb-8">
            Apply, track and manage microloans seamlessly with a transparent
            and modern digital platform built for borrowers and organizations.
          </p>
      ...
      <section
        className="
          ...
          dark:from-purple-900 dark:via-indigo-900 dark:to-pink-900
          transition-colors duration-500
        "
      >
        <h2 className="text-3xl md:text-4xl font-bold mb-6">
